...
appropriate for the source, sink, and storage
facility.
...
The Cycamore reactor facility implements a simple
recipe based model for transmutation of material.
That is, the user provides matched pairs of input
recipes and output recipes that must correspond to
other reactor parameters such as cycle length,
discharge burnup and power level.
