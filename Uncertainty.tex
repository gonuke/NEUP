...
Once we have a working predictive model and a map of the error on the prediction, one need to build the variance-covariance matrix which will allow to convolute the uncertainty on the input material, $\delta _{in}$, with the prediction of the model.\\
